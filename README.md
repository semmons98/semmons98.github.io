...
In terms of research, I work with Dr. Rogier Windhorst's cosmology research group at ASU - currently using JWST images to study star formation during cosmic noon. Comnpleted research projects include work on planetary science/seismology and astrobiology, both of which I am interested in building upon as future projects. 

As an astronomy student I have spent a fair amount of time programming for classes or research, but I also often enjoy making silly programs like using the golden ratio to approximate the convertion between miles and kilometers or building a tic-tac-toe game using Python's Matplotlib to display the board state. 
...
My full CV can be found <a href="{{ site.baseurl }}/pdfs/Resume.pdf" target="_blank">here</a>.
